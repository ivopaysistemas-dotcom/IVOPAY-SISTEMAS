...
const CustomerSheetPreview: React.FC<CustomerSheetPreviewProps> = ({ customer, onClose }) => {
  ...
  const handlePrintToPdf = async () => {
    ...
    // Abre uma nova guia imediatamente para evitar bloqueadores de pop-up
    ...
    try {
      ...
      // Carrega a URL do PDF na nova guia
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* -- Componente da Ficha do Cliente (visível antes da impressão) -- */}
